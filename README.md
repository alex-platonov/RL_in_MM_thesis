...
Key words: #Reinforcement_learning, #Deep_reinforcement_learning, #Market_making, #Inventory_management, #Adaptive_quoting, #Limit_order_book, #Markov_chains, #SPM, #HFT, #Electronic_financial_markets, #PnL_optimization, #LLMs_in_trading, #Q-Learning #DDQN
